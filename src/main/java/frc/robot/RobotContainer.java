...
//        buttonHelper.createButton(4, 1, new DoubleStationAlignCommand(drivetrainSubsystem, primaryController::getLeftY, AutoConstants.ALIGNMENT_POSITION.SINGLE_STATION), RunCondition.WHEN_PRESSED);
        buttonHelper.createButton(9, 1, new DoubleStationAlignCommand(drivetrainSubsystem, primaryController::getLeftY, AutoConstants.ALIGNMENT_POSITION.LEFT_DOUBLE_STATION), RunCondition.WHILE_HELD);
        buttonHelper.createButton(10, 1, new DoubleStationAlignCommand(drivetrainSubsystem, primaryController::getLeftY, AutoConstants.ALIGNMENT_POSITION.RIGHT_DOUBLE_STATION), RunCondition.WHILE_HELD);
