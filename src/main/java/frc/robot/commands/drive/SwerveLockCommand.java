...
public class SwerveLockCommand extends CommandFactory {
    public class SwerveLockImpl extends CommandBase {
        private final DrivetrainSubsystem drivetrainSubsystem;

        public SwerveLockImpl(DrivetrainSubsystem drivetrainSubsystem) {
    ...
    public CommandBase create() {
        return new SwerveLockImpl(drivetrainSubsystem);
    }
}
