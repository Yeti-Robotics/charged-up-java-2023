...
public final class WristConstants {
    ...
    public static final double ENCODER_OFFSET = 217.008;
    ...
    public static final double WRIST_P = 0.2; //PLACEHOLDER VALUE
    ...
    public static final double MAX_VELOCITY = 500.0; //PLACEHOLDER VALUE
    ...
    public enum WristPositions {
        ...
        INTAKE_CONE_TIPPED_GROUND(120.0),
        INTAKE_CONE_UPRIGHT_GROUND(95.0),
        INTAKE_CUBE_GROUND(103.0);
